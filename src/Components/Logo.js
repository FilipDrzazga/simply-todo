        ...
        <S.LogoContainer>
            <svg width="80" height="69" viewBox="0 0 80 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Group 27">
                    ...
                    <circle id="Ellipse 4" cx="23.7677" cy="26.6233" r="8.62836" transform="rotate(-45 23.7677 26.6233)" fill="#D9D9D9" />
                    <circle id="Ellipse 3" cx="67.0303" cy="41.0442" r="8.62836" transform="rotate(-45 67.0303 41.0442)" fill="#D9D9D9" />
                    <circle id="Ellipse 2" cx="53.2023" cy="26.2024" r="8.62836" transform="rotate(-45 53.2023 26.2024)" fill="#D9D9D9" />
                    <circle id="Ellipse 1" cx="38.1884" cy="12.2024" r="8.62836" transform="rotate(-45 38.1884 12.2024)" fill="#D9D9D9" />
                </g>
            </svg>
        </S.LogoContainer>
    );
